...
function EditorUi(editor, container, lightbox) {
    ...
    // Hides context menu
    mxEvent.addGestureListeners(document, mxUtils.bind(this, function () {
    ...
    let styles = ['rounded', 'shadow', 'glass', 'dashed', 'dashPattern', 'comic', 'labelBackgroundColor'];
    let connectStyles = ['shape', 'edgeStyle', 'curved', 'rounded', 'elbow', 'comic', 'jumpStyle', 'jumpSize'];
    ...
    // for the html key this effectively only works for edges inserted via the connection handler)
    ...
    let keyGroups = [['startArrow', 'startFill', 'startSize', 'endArrow', 'endFill', 'endSize', 'jettySize', 'orthogonalLoop'],
    ...
    let insertHandler = function (cells, asText) {
...
EditorUi.prototype.initCanvas = function () {
    ...
    if (this.editor.isChromelessView()) {
        ...
        // Hack to make function available to subclasses
        this.chromelessResize = resize;

        // Hook for subclasses for override
...
(function () {
    let codec = new mxObjectCodec(new ChangePageSetup(), ['ui', 'previousColor', 'previousImage', 'previousFormat']);
